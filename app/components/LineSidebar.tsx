...
export interface LineSidebarProps {
  ...
  activeIndex?: number | null; // NUEVO: permite control externo (ej. scroll horizontal sincronizado)
...
const LineSidebar = ({
  ...
  smoothing = 100,
  defaultActive = null,
  activeIndex: controlledActiveIndex, // NUEVO
  onItemClick,
  className = ''
}: LineSidebarProps) => {
  ...
  // NUEVO: si viene activeIndex controlado, sincroniza el estado interno
  useEffect(() => {
